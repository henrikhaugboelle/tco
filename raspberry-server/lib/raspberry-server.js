...
var NetworkNode = require('./networknode'),
	...
	SecondConverter = require('./converters/converter-second'),
	ThirdConverter = require('./converters/converter-third'),
	WalkConverter = require('./converters/converter-walk'),
	ColorConverter = require('./converters/converter-color'),
